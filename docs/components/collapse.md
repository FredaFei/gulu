  ...
  <div>
    ...
    <div class="section">
      ...
      <am-collapse :selected.sync="selected3" single>
        ...
        <am-collapse-item title="地海传说 ゲド戦記 (2006)" name="2">
          <div class="desc">
        ...
        <am-collapse-item title="幽灵公主 もののけ姫 (1997)" :visibleIcon="false" name="3">
        ...
        <am-collapse-item title="侧耳倾听 耳をすませば (1995)" name="4">
          <div class="desc">
        ...
        <am-collapse-item title="红猪 紅の豚 (1992)" name="5">
          <div class="desc">
