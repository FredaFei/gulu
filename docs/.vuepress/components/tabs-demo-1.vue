...
import AmTabs from "../../../src/tabs/tabs";
import AmTabsHeader from "../../../src/tabs/tabsHeader";
import AmTabsItem from "../../../src/tabs/tabsItem";
import AmTabsBody from "../../../src/tabs/tabsBody";
import AmTabsPane from "../../../src/tabs/tabsPane";
export default {
  components: {
    AmIcon,
    AmButton,
